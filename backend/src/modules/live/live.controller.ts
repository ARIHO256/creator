...
export class LiveController {
  ...
  @Post('live/builder/save')
  saveBuilder(@CurrentUser() user: RequestUser, @Body(new FlexiblePayloadValidationPipe(SaveLiveBuilderDto)) body: SaveLiveBuilderDto) {
    return this.service.saveBuilder(user.sub, body);
  }
  @RateLimit({ limit: 10, windowMs: 60_000 })
  @Post('live/builder/:id/publish')
  publishBuilder(@CurrentUser() user: RequestUser, @Param('id') id: string, @Body(new FlexiblePayloadValidationPipe(PublishLiveBuilderDto)) body: PublishLiveBuilderDto) {
  ...
  @Post('live/sessions')
  createSession(@CurrentUser() user: RequestUser, @Body(new FlexiblePayloadValidationPipe(UpsertLiveSessionDto)) body: UpsertLiveSessionDto) {
    return this.service.createSession(user.sub, body);
  }
  @RateLimit({ limit: 40, windowMs: 60_000 })
  @Patch('live/sessions/:id')
  updateSession(@CurrentUser() user: RequestUser, @Param('id') id: string, @Body(new FlexiblePayloadValidationPipe(UpsertLiveSessionDto)) body: UpsertLiveSessionDto) {
    return this.service.updateSession(user.sub, id, body);
  }
  ...
  @RateLimit({ limit: 30, windowMs: 60_000 })
  @Patch('live/studio/:id')
  updateStudio(@CurrentUser() user: RequestUser, @Param('id') id: string, @Body(new FlexiblePayloadValidationPipe(UpdateLiveStudioDto)) body: UpdateLiveStudioDto) {
    return this.service.updateStudio(user.sub, id, body);
  }
  @RateLimit({ limit: 20, windowMs: 60_000 })
  ...
  @Post('live/studio/:id/moments')
  addMoment(@CurrentUser() user: RequestUser, @Param('id') id: string, @Body(new FlexiblePayloadValidationPipe(CreateLiveMomentDto)) body: CreateLiveMomentDto) {
    return this.service.addMoment(user.sub, id, body);
  }
  ...
  @RateLimit({ limit: 40, windowMs: 60_000 })
  @Patch('live/replays/:id')
  updateReplay(@CurrentUser() user: RequestUser, @Param('id') id: string, @Body(new FlexiblePayloadValidationPipe(UpdateLiveReplayDto)) body: UpdateLiveReplayDto) {
    return this.service.updateReplay(user.sub, id, body);
  }
  @RateLimit({ limit: 10, windowMs: 60_000 })
  @Post('live/replays/:id/publish')
  publishReplay(@CurrentUser() user: RequestUser, @Param('id') id: string, @Body(new FlexiblePayloadValidationPipe(PublishLiveReplayDto)) body: PublishLiveReplayDto) {
    return this.service.publishReplay(user.sub, id, body);
  }
  ...
  @RateLimit({ limit: 30, windowMs: 60_000 })
  @Patch('tools/audience-notifications')
  patchAudience(@CurrentUser() user: RequestUser, @Body(new FlexiblePayloadValidationPipe(UpdateLiveToolDto)) body: UpdateLiveToolDto) { return this.service.toolPatch(user.sub, 'audience-notifications', body); }
  @RateLimit({ limit: 30, windowMs: 60_000 })
  @Patch('tools/live-alerts')
  patchAlerts(@CurrentUser() user: RequestUser, @Body(new FlexiblePayloadValidationPipe(UpdateLiveToolDto)) body: UpdateLiveToolDto) { return this.service.toolPatch(user.sub, 'live-alerts', body); }
  @RateLimit({ limit: 30, windowMs: 60_000 })
  @Patch('tools/overlays')
  patchOverlays(@CurrentUser() user: RequestUser, @Body(new FlexiblePayloadValidationPipe(UpdateLiveToolDto)) body: UpdateLiveToolDto) { return this.service.toolPatch(user.sub, 'overlays', body); }
  @RateLimit({ limit: 30, windowMs: 60_000 })
  @Patch('tools/post-live')
  patchPostLive(@CurrentUser() user: RequestUser, @Body(new FlexiblePayloadValidationPipe(UpdateLiveToolDto)) body: UpdateLiveToolDto) { return this.service.toolPatch(user.sub, 'post-live', body); }
  @RateLimit({ limit: 30, windowMs: 60_000 })
  @Patch('tools/streaming')
  patchStreaming(@CurrentUser() user: RequestUser, @Body(new FlexiblePayloadValidationPipe(UpdateLiveToolDto)) body: UpdateLiveToolDto) { return this.service.toolPatch(user.sub, 'streaming', body); }
  @RateLimit({ limit: 30, windowMs: 60_000 })
  @Patch('tools/safety')
